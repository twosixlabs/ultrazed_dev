...
#define CONFIG_SERVERIP	172.20.12.33
...
/* PREBOOT */
#define CONFIG_PREBOOT	"echo U-BOOT for zynqmp;setenv preboot; echo; dhcp"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"default_bootcmd=run uenvboot; run cp_kernel2ram && run cp_dtb2ram && bootm ${netstart} - ${dtbnetstart}\0" \ 
""
